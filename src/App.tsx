          ...
          <ParallaxLayer offset={1}>
            <section>
              ...
              <Fade duration={2000} cascade damping={0.15}>
                ...
                <h1>
                  Over <span style={{ fontSize: 40, color: "red" }}>50%</span>{" "}
            ...
            <section>
              <Fade cascade damping={0.1} style={{ maxWidth: "600px" }}>
                <h1>
                  ...
                  the same type of investments as their older peers? Does age
                  have any impact on if you see blockchain content?
                </h1>
              ...
              >
                ...
                <Fade style={{ textAlign: "center" }}>
                  ...
                  <h2>
                    ...
                    behavior to receive a similar distribution of
                    recommendations!
                  </h2>
                </Fade>
              </div>
            ...
            <section>
              <Fade style={{ textAlign: "center" }}>
                <strong>
                  <p style={{ fontSize: 30 }}>
                    {" "}
                    We've collected 120 'seed videos' for our users to build
                    their watch histories. Each user will watch 60 of these
                    videos.
                    <br></br>
                    40 of these videos are used to identify the age of the user
                    to YouTube. (Twenty for each age group)
                    <br></br>
                    80 of these videos are used to identify what type of videos
                    the user is looking for (40 for the traditional and
                    blockchain labels each.)
                    <br></br>
                    Our average investor watches the twenty shortest videos from
                    each label! Each user watches 50% of the video to
                    demonstrate that they have the same interest in all videos!
                  </p>
                </strong>
              </Fade>
              <br></br>
              ...
              <Fade style={{ textAlign: "center" }}>
                <strong>
                  <p style={{ fontSize: 30 }}>
                    ...
                    <br></br>● Interest in prompt‘engineering’ to fine-tune a
                    model
                    <br></br>● Through prompting, we can interpret model
                    decisions by asking it to explain itsrationale
                  </p>
                </strong>
              </Fade>
            </section>
